...
## ⚡ P0 — done 작업이 화면 결정 대기에 남는 결함 — tasks.json fetch 캐시 완전 우회
...
- Vercel/CDN/브라우저 캐시가 옛 

- **자율성**: 🟡 SEMI
- **예상 시간**: 미정시간
- **카테고리**: fix
- **상태**: in_progress
- **ID**: `BL-TASKS-CACHE-BUST` (출처: 대표님 직접 보고 (2026-05-11) — BL-003 결정 확정 직접 박았는데도 화면에 결정 대기로 남아있음)
