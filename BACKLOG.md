...
## 🟢 P0 — [자동] 작업 260건 중 3건에 출처가 없어요 (자동 동기화 봇 멈춤 위험)

**요약**: 점검 봇 자동 등록 (2026-05-27T01:51:12.967Z)
...
- **카테고리**: infrastructure
- **상태**: pending
- **ID**: `BL-AUTO-TASKS-SCHEMA-3MISSING` (출처: auto_from_tasks_schema)
...
## ⚡ P1 — [정책 기록 누락 검증 봇] D5 위반 감지 — 결정 박힌 후 2벌 저장 안 됐는지 자동 점검

- **자율성**: 🟡 SEMI
- **예상 시간**: 미정시간
- **카테고리**: ops-discipline
- **상태**: in_progress
- **ID**: `BL-DECISIONS-AUDIT-BOT` (출처: _business/decisions/2026-05-27-incident-and-new-rules.md#D15)
