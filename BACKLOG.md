...
## 🟡 P0 — [허브 페이지] 매니저 통합 VIEW 박기 (v_hotel_manager_full)
...
- **카테고리**: infra
- **상태**: pending
- **ID**: `BL-MANAGER-HUB-VIEW` (출처: chat:2026-05-13 매니저 허브 페이지 설계)

---

## 🟡 P0 — [허브 페이지] 가입자 클릭 → 좌우 분할 상세 페이지 (Aurora)
...
- **카테고리**: feature
- **상태**: pending
- **ID**: `BL-MANAGER-HUB-PAGE` (출처: chat:2026-05-13 매니저 허브 페이지 설계)

---

## 🟡 P0 — [허브 좌측] 매니저 본인 화면 실제 연동 (호텔 정보·예약·매출·영상)
...
- **카테고리**: feature
- **상태**: pending
- **ID**: `BL-MANAGER-IMPERSONATE` (출처: chat:2026-05-13 매니저 허브 페이지 설계)
...
## 🟡 P1 — [허브 우측] 수동 푸시 버튼 4개 — 실제 메일 발송 + 템플릿
...
- **카테고리**: feature
- **상태**: pending
- **ID**: `BL-MANAGER-MANUAL-PUSH` (출처: chat:2026-05-13 매니저 허브 페이지 설계)
