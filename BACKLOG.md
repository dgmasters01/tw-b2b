...
## ⚡ P0 — 페이지 지도 접기 + 결정 대기 영향력 순위 + 흐름 안내 갱신 주기

**요약**: 대표님 4가지 본질 지적:
1. 페이지 지도가 화면 너무 차지 — 트랙별 접기/펼치기 필요
2. 지금 뭐부터 안내가 계속 바뀌는지 표시 안 됨 — 5초 자동 갱신 chip 추가
3. 결정 P0 5건 중 무엇부터 — 영향력 순위 ① ② ③ 번호 박기
4. 결정 24건 정렬 기준 불명 — 영향력 점수(P0=100, P1=30 + 페이지 묶임당 +50)로 자동 

- **자율성**: 🟡 SEMI
- **예상 시간**: 미정시간
- **카테고리**: feature
- **상태**: in_progress
- **ID**: `BL-FLOW-CLARITY-V2` (출처: 대표님 직접 보고 (2026-05-11) — ①페이지 지도 카테고리 접기/펼치기 ②지금 뭐부터 갱신 주기 ③P0 5건 어떤건지 가장 먼저 ④결정 대기 24건 순서)
