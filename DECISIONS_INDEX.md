...
|---|---|:---:|:---:|:---:|---|
| D-121 | **「손님이 말한 숫자는 선(線)이다」 — 예산을 넘기지 않는다 (D-119 후속)** — 대표님: *«검색이 디테일하지 않은 것 같애. 15만 이하인데 17만원 19만원대 호텔이 뜸»*. 🔴 **원인** — 결과가 적으면 조건을 넓히면서 **예산까지 1.3배로 늘려 목록에 섞었다.** 「150,000원 이하」 딱지 밑에 179,040·192,586·194,226원이 앉았다. **실측(오사카·2026-11·5성급)**: 우리가 소개한 5성급은 **3곳뿐**이고 15만원 이하는 **0곳**(가장 싼 것 179,040원). 🔴 그런데 값이 «가장 가까운» 곳은 **150,146원 — 단 146원 초과**였고, 🔴 **4성급으로 보면 15만원 이하가 28곳** 있었다. **옛 방식은 「146원만 넘는 곳」을 「44,226원 넘는 곳」과 뒤섞어 묻어버렸다 — 넓히기는 정보를 더 준 게 아니라 «지운» 것이었다.** 정한 것 ①🔴 **손님이 말한 숫자는 선이다. 값·성급·달 모두 넘지 않는다** ②값이 조금 넘는 곳은 **섞지 않고 나눠서** — `near`(가장 가까운 6곳 · 얼마나 넘는지 `over` 와 함께)를 「150,000원 이하는 없습니다 / 가장 가까운 곳은 146원 넘습니다」 **별도 칸**으로 ③🔴 **「없습니다」로 끝내지 않는다** — `alt_star`·`alt_count` 로 「**4성급으로 보시면 28곳이 있습니다**」 단추(누르면 손님 문장에서 성급만 바꿔 다시 묻는다) ④**정말로 늘어났을 때만 「넓혔다」고 말한다**(전에는 2회차를 «돌기만 하면» 깃발이 켜져 아무것도 안 넓혔는데 「범위를 넓혔습니다」가 떴다). 넓히기에 남은 것은 **성급 밴드·숙소 종류뿐 — 값은 아니다.** **실측 전→후**: 목록에 17~19만원 → **목록 최고가 82,855원** · 가까운 곳 별도 6곳 · 대안 28곳. 기존 검색 3종 그대로 | ux | 2026-09-09 | 확정 | _business/decisions/2026-09-09-shop-search-budget-line.md, _business/shop/SHOP_TECH.md §45, _business/shop/SHOP_ROLLBACK.md §31, travelwinners-shop: api/search.js, public/search.html, sql/2026-09-09-search-engine.sql |
| D-120 | **검색 결과 맨 아래는 「아고다」가 아니라 「그 도시 추천 상품」 (D-114 ② 갱신)** — 대표님: *«이거는 넣지 말자»* · *«아고다에서 찾기 넣지 말고, 후쿠오카 추천상품을 보여주는 게 맞어»*. D-114 의 «1층=우리 것 / 2층=아고다» 중 **2층을 검색 화면에서 내린다**. 찾던 숙소를 못 찾은 손님을 남의 집으로 보내는 대신 **우리가 가진 것을 내민다** — 「후쿠오카 10월 10만원」으로 온 손님은 «후쿠오카에 갈 사람»이므로 근교 버스투어·지하철 패스·수족관 입장권을 보여주는 편이 맞다. 🔴 **부품은 `shop.js` `mountCityProducts` 한 곳**(세부 화면과 같은 것 · 검색 화면 안에 다시 만들지 않음) 🔴 **도시를 못 알아들은 검색(「일본 10만원 3성급」)에서는 칸 자체를 넣지 않는다** 🔴 **`agodaLink()` 함수도 함께 지웠다**(안 쓰는 길을 남기면 다음 사람이 살아 있는 길로 오해한다). **잃는 것/얻는 것** — 아고다 이어검색 수수료 길 하나가 없어지고 대신 **KKday 추천 상품**(cid 15352 · 도시마다 10개)이 들어간다: 수익 길이 사라지는 게 아니라 **바뀐다**. 🔴 **D-114 의 1층(소개 호텔+신상)과 호텔 예약 링크(`/go/…`→아고다)는 그대로다** — 없앤 것은 「아고다 검색창으로 보내는 안내판」 하나뿐. 실측: 후쿠오카·오사카·다낭 모두 `scope=city` 상품 10개가 이미 있어 새로 만들 것이 없었다 | ux | 2026-09-09 | 확정 | _business/decisions/2026-09-09-shop-search-tail-products.md, _business/shop/SHOP_ROLLBACK.md §30, travelwinners-shop: public/search.html |
| D-119 | **검색이 「달」을 이해한다 (D-118 후속)** — 대표님: *«내가 10월 10만원이라고 넣었는데 … 10월에 10만원 미만을 찾아줘야 되지 않나? 그런데 지금은 9월달 거 아무거나 나오고 8만원대 나왔다가 18만대 나오고»*. 🔴 **원인 둘** ①`parse()` 에 달 규칙이 없어 「10월」이 «찾을 이름»으로 남았고 값은 **언제나 가장 가까운 달(9월)** 을 썼다 ②조건을 넓히는 회차에서 **예산을 통째로 풀어** 「100,000원 이하」 딱지 밑에 **180,435원**이 앉았다. 정한 것 ①「10월」·「다음 달」·「이번 달」을 조건으로 받는다(🔴 **예산보다 먼저** 뽑는다 · 「10월」은 **다가오는** 10월) ②🔴 **우리가 값을 «잰 달»만 답한다** — 못 잰 달은 «3월 값은 아직 재지 못했습니다 / 지금 값이 있는 달: 9·10·11·12월»로 **정직하게 밝히고** 가장 가까운 날짜로 안내. 없는 달에 다른 달 값을 슬쩍 보여주면 손님이 아고다에서 다른 값을 만나고 다시 오지 않는다 ③🔴 **「넓힌다」는 «없앤다»가 아니다** — 소개·신상 둘 다 **1.3배까지만**, 화면에 «값은 130,000원까지 함께 보여드립니다»로 얼마나 넓혔는지 밝힌다(딱지와 목록이 다르면 손님은 속았다고 느낀다) ④신상 값을 `shop_new_live` 에서 따로 읽던 것을 **`shop_price_month` 한 곳으로 합침**(실측 3,498곳 차이 0). **실측 전→후**: 「후쿠오카 10월 10만원」 9월 값·180,435원 섞임 → **10월 값만 · 소개 14 · 신상 6 · 목록 최고가 98,692원** · 「다음 달 오사카 10만원」 못 읽음 → **10월 1등 49,974원(10-04)**. 답할 수 있는 달 = 2026-09(4,558곳)·10월(4,533)·11월(4,493)·12월(4,428, 5일치) — 봇이 53일치를 굴려 창이 매일 앞으로 밀린다. 🔴 **날짜 범위(「10월 말」·「10/15~18」)는 아직 안 한다** — 지금은 달 단위까지. 🔴 **함정**: 창고 함수 인자를 «가운데» 끼워 넣으면 순서로 부르던 곳이 깨진다 — **부르는 쪽은 이름으로**(`p_q=>…`) | ux | 2026-09-09 | 확정 | _business/decisions/2026-09-09-shop-search-month.md, _business/shop/SHOP_TECH.md §44, _business/shop/SHOP_ROLLBACK.md §29, travelwinners-shop: api/search.js, public/search.html, sql/2026-09-09-search-engine.sql |
...
| D-121 | 2026-09-09 (상세=_business/decisions/2026-09-09-shop-search-budget-line.md) | 예산을 넘기지 않는다 · 가장 가까운 곳/대안 성급 |
| D-120 | 2026-09-09 (상세=_business/decisions/2026-09-09-shop-search-tail-products.md) | 검색 결과 아래 = 도시 추천 상품 (D-114 ② 갱신) |
| D-119 | 2026-09-09 (상세=_business/decisions/2026-09-09-shop-search-month.md) | 검색이 「달」을 이해한다 (D-118 후속) |
...
| 날짜 | 변경 내용 |
|---|---|
| 2026-09-09 | D-121 등록 (손님이 말한 숫자는 선이다 — 예산을 넘기지 않고, 가장 가까운 곳과 대안 성급을 따로 준다) |
| 2026-09-09 | D-120 등록 (검색 결과 아래 「아고다에서 찾기」 → 그 도시 추천 상품 · D-114 2층 갱신) |
| 2026-09-09 | D-119 등록 (검색이 「10월」 같은 달을 조건으로 받는다 · 넓힐 때 예산을 통째로 풀지 않는다) |
