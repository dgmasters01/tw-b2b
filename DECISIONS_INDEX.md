...
| 날짜 | 변경 내용 |
|---|---|
| 2026-09-02 | D-103·D-104 등록 (화면 세는법 정정·기준선 8→15장 · 창구 열쇠 자가 조달) |
...
| 2026-09-02 | D-103 | D-103 · 「시스템 완성도」 화면은 세는 법부터 고친다 | `_business/decisions/2026-09-02-admin-status-counting.md` |
| 2026-09-02 | D-104 | D-104 · 창구 열쇠는 클로드가 스스로 찾는다 | `_business/decisions/2026-09-02-ops-token-self-retrieval.md` |

**등재 51건** · 전체 결정문서 59건 · 이 표에 파일명이 있으면 감시 봇이 이슈를 자동으로 닫는다.
