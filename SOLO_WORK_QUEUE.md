...
### B. 🟡 SEMI — 결정 영향력 카드 — 어떤 결정 박으면 어떤 BL/페이지가 풀리는지 한눈에

**ID**: `BL-DECISION-IMPACT-CARD`  
**카테고리**: feature  
**예상 시간**: 미정시간  
...
fix: admin-status에 "결정 영향력 카드" 신설. 각 결정마다 박혀있을 때 풀리는 BL 목록 + 페이지 영향 + 영향력 점수 표시. 대표님이 영향력 큰 결정부터 박을 수 있게.
