...
## 현재 단계
설계 완료(구성 전략 확정) · **파일럿 도메인 이름 확정(staycurate.com, 구매 대기, D-B14)** · 첫 글 착수 직전.
...
- 도메인(D-B11·D-B14): 파일럿 이름 **staycurate.com** 확정(구매 대기, 대표님 직접 구매). **독립 브랜드 전략**(사이트끼리 '한 운영자'로 안 보이게 · footprint 분산 · 브랜드 연장안 폐기). 확장은 각자 구매·소유, 어근 분산. 키워드+브랜드형 .com.
- 발행: 지속가능한 질 우선. 반자동 생산 + 사람 검수. 소재 = 나라×도시×포맷 + 갱신.

## 다음 할 일 (우선순위)
1. **대표님: staycurate.com 구매**(Cloudflare Registrar 1순위) → 이름 알려주시면 Claude가 Vercel 프로젝트 생성·연결
