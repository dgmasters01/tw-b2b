...
## 🎯 한 줄 요약
admin-status v2 UX 명확성 — KPI 클릭 시 강한 시각 안내 + 0건 메시지 의미화 + 활동 이력 시간근접 매핑

## 📍 왜 발생했나
**선행**: BL-STATUS-FINAL (작업 c545cd9)

## 🛠 어떻게 해결했나
"KPI 4곳 클릭하면 같은 곳으로 가는 것 같다 — 어디인지 표시 없음" / "활동 이력 작업 기록 못 찾음" — 작업 안 된거지? / "임박 작업 (P0+진행중) — 직원 트리거 가능 전체 0건" 무슨 의미?
