...
## 📊 현재 상태 한눈에 (verification-gap-bot 자동 갱신)

**총 15건** — ✅ DONE 9 / 🟡 PARTIAL 3 / ❌ NOT_IMPLEMENTED 3

### ❌ 미구현 사업 합의 (우선순위순)

| ID | 합의 | 합의 일자 | 관련 BL | 며칠째 |
|---|---|---|---|---|
| AGR-2026-0005 | 한국 매니저 수동 입금 확인 admin | 2026-05-24 | BL-INVOICE-002 (0%) | 1일 |
| AGR-2026-0013 | 한국 결제 영수증 종류 라디오 3종 | 2026-05-24 | BL-INVOICE-001 | 1일 |
| AGR-2026-0014 | B2B 안내 문구 (영수증 라디오 옆) | 2026-05-24 | BL-INVOICE-001 | 1일 |

### 🟡 부분 박힌 합의

| ID | 합의 | 상태 |
|---|---|---|
| AGR-2026-0004 | PayPal 자동 + KRW 수동 하이브리드 | PayPal만 박힘, KRW는 AGR-0005에 종속 |
| AGR-2026-0007 | 한국 KRW 단일, 발행 시점 환율 스냅샷 | 일부 파일 갱신 필요 |
| AGR-2026-0015 | 인보이스 번호 4트랙 + super_admin 단독 | 일부 파일 갱신 필요 |

### ✅ 최근 완료

| ID | 합의 | 완료 일자 |
|---|---|---|
| AGR-2026-0003 | **한국 매니저 KRW 송금 분기 (sales.html)** | 2026-05-25 (verification-gap-bot 자동 검증 통과) |
