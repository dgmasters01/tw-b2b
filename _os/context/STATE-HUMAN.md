...
**스튜디오** (2026-09-02 재분류 · D-103)
- 열린 작업 72건 · 그중 **🔑 대표님 몫은 2건뿐**
...
**작성**: 2026-09-02 (D-103·D-104 반영) · 정본 `_os/context/state.json` 에서 옮김 · 값이 바뀌면 json 을 고치고 이 문서도 다시 만든다